...
if ( is_admin("se3_is_admin",$login)!="Y")  if ( ($uid != $login) || (($uid == $login)&&((!ereg("/home/$login", $wrep))&&($consul!=1))))  die (gettext("Vous n'avez pas les droits suffisants pour accéder à cette fonction")."</BODY></HTML>");
...
//
$update_virus_time = filemtime("/var/lib/clamav/daily.inc/daily.inf");
